...
def spec_inspec(n1,n2):
    ...
    f_out = open("/Users/tammour/NLS1_sept2015/data-fig/obj_flg"+str(n1)+"_"+str(n2)+".txt", 'wr')
    

    for s in spec_ls[n1:n2]:
        try:

            spec= Table.read("/Users/tammour/HDstuff/atiaf-final-oct12-2011/data/"+s+".plt", format= 'ascii', data_start=2)
            ...
            ax2= plt.subplot2grid((10,10), (8, 0), colspan=10, rowspan=2)
            ylabel('Residuals')
            ax2.set_ylim(-10,10)
